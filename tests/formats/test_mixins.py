...
class AbstractGeneratorTests(FactoryTestCase):
    ...
    def test_render_header(self, mock_datetime) -> None:
        ...
        self.generator.config.output.custom_header = "   \n  "
        self.assertEqual("", self.generator.render_header())

        mock_datetime.now.return_value = datetime.datetime(
            year=2023, month=2, day=22, hour=10, minute=20, second=25
        )

        self.generator.config.output.custom_header = None
        self.generator.config.output.include_header = True
        actual = self.generator.render_header()
        now_iso_format = "2023-02-22 10:20:25"
        expected = (
            f'"""This file was @generated by pyxsdata, v{__version__}, on {now_iso_format}\n'
            "\n"
        ...
        # Test custom_header only
        self.generator.config.output.include_header = False
        self.generator.config.output.custom_header = "# @generated\n# mypy: ignore-errors"
        actual = self.generator.render_header()
        self.assertEqual("# @generated\n# mypy: ignore-errors\n", actual)

        # Test both custom_header and include_header together
        self.generator.config.output.include_header = True
        actual = self.generator.render_header()
        expected_combined = (
            "# @generated\n"
        ...
        self.assertEqual(expected_combined, actual)
