...
```console
$ pyxsdata generate --config project/.pyxsdata.xml
```
...
The generator will add an informational module docstring in all output files. The header
includes the `@generated` marker, which is recognized by tools such as
[Pyrefly](https://pyrefly.org/en/docs/configuration/#ignore-errors-in-generated-code)
(`ignore-errors-in-generated-code = true`) and GitHub Linguist (collapsing large
generated diffs in pull requests).

**Example**

```python
"""This file was @generated by pyxsdata, v0.0.0, on 2026-03-01 10:20:25

Generator: DataclassGenerator
See: https://nth-bailey.github.io/pyxsdata/
"""
```
...
Prepend custom header text (such as pragmas, license notices, or tool directives) to all
generated output files. This is useful for adding `# @generated`,
`# mypy: ignore-errors`, `# ruff: noqa`, or SPDX license notices without forcing
volatile timestamps into generated files.
...
<Config xmlns="http://pypi.org/project/xsdata">
  <Output>
    <CustomHeader># @generated
# mypy: ignore-errors</CustomHeader>
  </Output>
</Config>
```
...
**CLI Option:** `-ch, --custom-header TEXT`
