...
from pyxsdata.codegen import opener
...
from pyxsdata.codegen.parsers import DtdParser
from pyxsdata.codegen.parsers.definitions import DefinitionsParser
from pyxsdata.codegen.parsers.schema import SchemaParser
from pyxsdata.codegen.stopwatch import stopwatch, stopwatches
...
from pyxsdata.models.wsdl import Definitions
...
class ResourceTransformer:
    ...
    def get_cache_file(cls, uris: list[str]) -> Path:
        ...
        return Path(tempdir).joinpath(f"pyxsdata.{__version__}.{key}.cache")
