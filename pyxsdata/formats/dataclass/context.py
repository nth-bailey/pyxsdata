...
from pyxsdata.formats.dataclass.models.builders import XmlMetaBuilder
from pyxsdata.formats.dataclass.models.elements import XmlMeta
...
class XmlContext:
    ...
    def find_types(self, qname: str) -> list[type]:
    ...
    def find_type(self, qname: str) -> type | None:
    ...
    def find_type_by_fields(self, field_names: set[str]) -> type | None:
