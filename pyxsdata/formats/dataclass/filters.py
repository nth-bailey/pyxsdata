...
from pyxsdata.utils import collections, namespaces, text
from pyxsdata.utils.objects import literal_value
...
class Filters:
    ...
    def register(self, env: Environment) -> None:
        ...
        env.globals["docstring_name"] = (  # ty: ignore[invalid-assignment]
            self.docstring_style.name.lower()
        )
        env.filters.update(
            {
